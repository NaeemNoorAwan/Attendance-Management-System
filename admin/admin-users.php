...
<div class="modal fase" id="showUserDetailsModal">
        ...
        $("body").on("click", ".userDetailsIcon", function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#getCreated").text('Joined At: ' + data.created_at);
                    ...
                    if (data.photo != '') {
                        ...
                        $("#getImage").html('<img src="../assets/img/no_image_available.PNG" class="img-thumbnail img-fluid align-self-center width="280px">');
                    }
                }
            });
        });
