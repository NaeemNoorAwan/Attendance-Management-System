...
<head>
    ...
    <title>Attendance Management System | NaeemNoorSoft</title>
    <!-- Bootstrap 4 CSS CDN -->
            ...
            <div class="col-lg-10 my-auto myShadow">
                <div class="row">
                    ...
                    <div class="col-lg-5 d-flex flex-column justify-content-center myColor p-4">
                        ...
                        <a class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="admin-link" href="admin/">Admin Login</a>
                    </div>
                </div>
            </div>
        </div>
